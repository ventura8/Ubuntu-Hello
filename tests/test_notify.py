...
def test_state_paths_root_uses_private_root_dir_not_users_runtime_dir(tmp_path):
    ...
    with patch("notify.os.geteuid", return_value=0), patch("notify.ROOT_STATE_DIR", root_dir):
    ...
    with patch("notify.os.geteuid", return_value=0), patch("notify.ROOT_STATE_DIR", str(bad)):
