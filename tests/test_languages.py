...
def test_is_rtl_codes():
	import languages
	assert languages.is_rtl("ar")
	assert languages.is_rtl("he")
	assert languages.is_rtl("fa")
	assert languages.is_rtl("ur")
	assert languages.is_rtl("ar_EG.UTF-8")
	assert languages.is_rtl("ps")
	assert languages.is_rtl("sd")
	assert languages.is_rtl("yi")
	assert not languages.is_rtl("en")
	assert not languages.is_rtl("de")
	assert not languages.is_rtl("auto")
	assert not languages.is_rtl("")
