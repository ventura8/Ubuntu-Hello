...
* **Pinned CI deps** (explicit version tags/numbers only — never commit SHAs, never the `latest` alias):
  ...
  * GHA actions: explicit tags (e.g. `actions/checkout@v7.0.1`, `docker/setup-buildx-action@v4.3.0`, `softprops/action-gh-release@v3.0.3`)
