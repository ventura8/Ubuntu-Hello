# Fedora RPM spec for Ubuntu Hello (core + GTK subpackages)
# Version is passed at build time: rpmbuild -D "uh_version 1.1.3"
...
%prep
%autosetup -n ubuntu-hello-%{version}
