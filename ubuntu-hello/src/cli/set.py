...
if len(builtins.ubuntu_hello_args.arguments) < 2:
	print(_("Please add a setting you would like to change and the value to set it to"))
	print(_("For example:"))
	print("\n\tubuntu-hello set certainty 3\n")
	sys.exit(1)

# Get the name and value from the cli
set_name = builtins.ubuntu_hello_args.arguments[0]
set_value = builtins.ubuntu_hello_args.arguments[1]
